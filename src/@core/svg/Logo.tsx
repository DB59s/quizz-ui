...
const Logo = (props: SVGAttributes<SVGElement>) => {
  return (
    <svg width='1em' height='1em' viewBox='0 0 48 48' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
      ...
      <path d='M24 14C20.686 14 18 16.686 18 20H21C21 18.343 22.343 17 24 17C25.657 17 27 18.343 27 20C27 21.657 25.657 23 24 23V26H27V24.83C28.725 24.415 30 22.86 30 21C30 18.239 27.761 16 25 16C24.667 16 24.333 16.033 24 16.1V14Z' fill='#FFFFFF' />
