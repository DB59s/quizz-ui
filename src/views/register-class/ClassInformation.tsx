        ...
        <Box className="mt-6 pt-4 border-t border-gray-200">
          {registrationStatus.loading ? (
            <Box className="flex justify-center items-center p-4">
              ...
              <Typography variant="body2" className="ml-2">Đang kiểm tra trạng thái...</Typography>
            </Box>
          ) : joinSuccess || registrationStatus.isRegistered ? (
            <Alert severity={
              registrationStatus.registrationStatus === 'approved' ? 'success' :
              registrationStatus.registrationStatus === 'rejected' ? 'error' :
              'info'
            }>
